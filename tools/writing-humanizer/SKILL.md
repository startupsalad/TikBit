...
description: |
  ...
  尤其适用于讲标稿、述标稿、串场稿等需要"念出来"的口播稿，以及任何要求更口语化的文稿（见文末「口播稿专项」）。
...
allowed-tools:
  ...
  - AskUserQuestion
metadata:
  trigger: 编辑或审阅文本，去除 AI 写作痕迹；讲标稿/述标稿/串场稿/要求口语化时必用
...
## 口播稿专项：讲标稿 / 述标稿 / 串场稿 / 一切"要念出来"的稿子

口播稿的读者是耳朵，不是眼睛。评委、听众只听你念，不看稿。所以上面那套"看着干净"的标准还不够，得"念着顺"。下面几条是普通文章不强调、但口播稿最露馅的地方：

**1. 破折号一律清零。** 破折号（——）在纸面上是"停顿感"，可它念不出来，一念就是生硬的顿。全部换成逗号、句号，让标点直接标出你换气的地方。这是口播稿去 AI 味的第一刀，比任何词汇替换都管用。

**2. 删掉"自我预告"和元评论。** 书面稿爱铺垫，口播稿一铺垫就啰嗦。砍掉壳子，直接上内容：
- "我特别想说 / 我单独拎出来讲 / 这一点我讲透一点 / 有一条我必须强调" → 删，直接说那件事
- "这恰恰是最容易被忽略/做薄的一条" → 删，这种元评论听众不关心，把具体的给他就行
- 改写前：`需求里有一条我特别想说：线下课上完还得线上辅导。这条恰恰最容易缩水。很多同行……`
- 改写后：`很多培训课一结束，发份资料、建个群，就算有售后了。我们不这么干。`（直接上画面，对比自己就出来了，不用你替听众点评）

**3. 删金句、删点题句。** "分量就在'直至完成'四个字""我们图的不是热闹，是成果"这种可引用的漂亮话，写出来自我感觉良好，念出来假。换成大白话把事说清楚就够了。

**4. 方言腔要匹配听众的地域和身份。** AI（和北方长大的人）容易无意识带京味，在南方客户面前很跳戏。这类词换成中性普通话：
- "这个劲儿 / 不图…图的是 / 拎出来 / 门儿清 / 逐小时" → "这样 / 不追求…想的是 / 单独讲 / 很熟 / 按小时"
- 反过来，能贴听众本地身份的话可以留（对水务人说"活水""一潭死水"）。原则：贴听众，别贴稿子作者的口音。

**5. 流水句是口语的朋友。** 书面写作求短句、求整齐，口播反而"一逗到底"的流水句更像真人。真人是这么说话的：`很多骨干问题就摆在眼前，可他身在局中，跳不出来，我们这套方法就是帮他打破惯性、换个角度看，很多事一跳出来就迎刃而解了。` 一口气顺下来，别把它"优化"成三个整齐的排比短句。

**6. 加粗只当"念稿重音提示"，全篇不超过五六处。** 口播稿的粗体不是给听众看的（他们看不到），是给念稿人标"这里加重语气"。只在真要强调的那几句留，其余全清。堆一屏粗体既没用又是 AI 味。

**7. 终检靠嘴，不靠眼。** 交付前把整稿念一遍（或让作者念）。哪句绊嘴、哪句要回头看第二遍才顺、哪句一口气念不完，就是要改的地方。念着别扭的地方才是真别扭。

**8. 长度够了就只改语感。** 用户说"时长差不多了"之后，别再借去 AI 化的名义砍内容，只调顺口气、不动信息量。

> 一句话记法：口播稿去 AI 味 = **清破折号 + 删铺垫元评论 + 删金句 + 去方言腔 + 敢用流水句 + 粗体只当重音 + 念出来验收**。
